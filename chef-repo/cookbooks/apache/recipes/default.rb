apt_update 'Update the apt cache daily' do
  ...
  execute "php-dependencies1" do
    ...
    execute "php-dependencies7" do
     ...
     execute "php-dependencies8" do
      command "apt-get install -y php-mbstring"
      #ignore_failure true
      end


      execute "php-dependencies9" do
        command "apt-get install -y  php-mysql"
        #ignore_failure true
        end

        execute "php-dependencies10" do
          command "apt-get install -y php-xml"
          #ignore_failure true
          end

          execute "php-dependencies11" do
            command "apt-get install -y php-zip"
            #ignore_failure true
            end
